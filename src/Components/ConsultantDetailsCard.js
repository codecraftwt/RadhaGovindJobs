...
export default function ConsultantDetailsCard({item}) {
      ...
      <View style={styles.Information}>
        ...
        <View style={styles.ThirdRow}>
          <Image
            ...
            source={locationpng}
          />
          <Text style={styles.Text3}>{item?.users_info[0]?.village?.village} , {item?.users_info[0]?.taluka?.taluka}</Text>
        </View>
        <View style={styles.ThirdRow}>
          <Image
            resizeMode="contain"
            ...
            source={email}
          />
          <Text style={styles.Textedu}>{item?.email}</Text>
        </View>
        <View style={styles.ThirdRow}>
