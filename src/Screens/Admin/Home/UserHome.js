...
import { fetchJobData, savedJobsData } from '../../../Redux/Slices/Jobslice';
        ...
        {loading ? (
          ...
          <>
            <View style={{ paddingStart: w(5), paddingVertical: h(2) }}>
              <Text style={styles.titletxt}>{t("Find Your")}</Text>
              <Text style={styles.titletxt}>{t("Dream Job Here")}</Text>
            </View>
            <View
              style={{
                flexDirection: 'row',
